...
class TransformerModel(AttModel):
    ...
    def __init__(self, opt):
        ...
        ckpt_path = "/home/rzl/lab/nwpu-ImageCaption/checkpoints/RS5M_ViT-H-14.pt"
    ...
    def _prepare_feature_forward(self, att_feats, att_masks=None, seq=None):
        ...
        att_feats = att_feats.permute(0, 3, 1, 2)  # (b, c, w, h)

        att_feats = self.image_encoder(att_feats)

        att_feats = pack_wrapper(self.att_embed, att_feats, att_masks) # 加入了 att_embed层, 并进行了填充 # (b,  w*h, d_model)
