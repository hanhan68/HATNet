...
def parse_opt():
    ...
    parser.add_argument('--start_from', type=str, default=None,
                        ...
                        'model.pth'         : weights
                    """)
    parser.add_argument('--cached_tokens', type=str, default=None,
    ...
    parser.add_argument('--scheduled_sampling_start', type=int, default=-1, # 是否降低从GT采样的概率
    ...
    # misc
    parser.add_argument('--id', type=str, default='demo',
    ...
    parser.add_argument('--train_sample_n', type=int, default=16, # SCST训练时，每步采样几个
                        help='The reward weight from cider')
    ...
    # config
    parser.add_argument('--cfg', type=str, default="/home/rzl/lab/nwpu-caption/configs/transformer/transformer.yml",
...
def add_eval_options(parser):
    ...
    parser.add_argument('--image_folder', type=str, default='',  # 如果是外界的图片，的路径
