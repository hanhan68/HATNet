...
import sys
sys.path.append(project_root+"/cider")
...
if __name__ == "__main__":
    ...
    # input json
    parser.add_argument('--input_json', default='/home/rzl/lab/nwpu-caption/data/dataset.json', help='input json file to process into hdf5')
    parser.add_argument('--dict_json', default='/home/rzl/lab/nwpu-caption/data/nwpu_25.json', help='output json file')
    parser.add_argument('--output_pkl', default='/home/rzl/lab/nwpu-caption/data/nwpu-25', help='output pickle file')
