...
if __name__ == "__main__":
    ...
    # input json
    parser.add_argument('--input_json',default="/home/rzl/lab/nwpu-ImageCaption/data/dataset.json", nargs='+',
                        help='input json file to process into hdf5')
    parser.add_argument('--output_json', default='/home/rzl/lab/nwpu-ImageCaption/data/nwpu_val.json',
